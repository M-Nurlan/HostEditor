...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.addBtn.setGeometry(QtCore.QRect(370, 310, 81, 23))
        ...
        self.hostEditor = QtWidgets.QTextEdit(self.centralwidget)
        self.hostEditor.setGeometry(QtCore.QRect(20, 200, 431, 101))
